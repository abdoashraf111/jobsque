                    ...
                    TextFormField(
                      onChanged: (value) {
                          if (FormKey.currentState!.validate()) {
                            ...
                            BlocProvider.of<SignInCubit>(context).falseClickEnable();
                          }
                      },
                      validator: (value) {
                        if (value == "") {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: GestureDetector(
                              onTap: () {
                                  BlocProvider.of<SignInCubit>(context).showPassFun();
                              },
                    ...
                    Row(
                      children: [
                        Checkbox(
                          ...
                          value: checkBox,
                          onChanged: (value) {
                              BlocProvider.of<SignInCubit>(context).checkBoxValue(value: value);
                          },
